...
// ReSharper disable once InconsistentNaming
        ...
        /// </summary>
        /// <param name="ext">Extension of the specified file.</param>
        ...
        public IWaveSource GetCodec(string ext, Stream stream)
        {
        ...
        public IWaveSource GetCodec(Uri uri)
        {
            ...
            try
            {
                if (uri.IsFile)
                {
                    return GetCodec(uri.LocalPath, File.OpenRead(uri.LocalPath));
                }
...
#pragma warning restore 618
        ...
        private static IWaveSource Default(Stream stream)
        {
            return new MediaFoundationDecoder(stream);
        }

        private static IWaveSource Default(string uri)
        {
            return new MediaFoundationDecoder(uri);
        }
