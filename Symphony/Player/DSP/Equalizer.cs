using Symphony.Player.DSP.NAudio;
using System;
...
{
    public class Equalizer : DSPBase
    {
        public EqBand[] bands;
        ...
        public Equalizer(ref PlayerCore dsp, EqBand[] bands, float preAmp, bool on, float opacity)
        {
            player = dsp;
        ...
        public Equalizer(ref PlayerCore dsp)
        {
            player = dsp;
            DSPmaster = dsp.DSPMaster;
            this.opacity = 1f;
            ...
            bands = new EqBand[]
                    {
                        new EqBand {Bandwidth = 0.35f, Frequency = 31, Gain = 0},     //1
                        new EqBand {Bandwidth = 0.35f, Frequency = 62, Gain = 0},     //2
                        new EqBand {Bandwidth = 0.35f, Frequency = 150, Gain = 0},    //3
                        new EqBand {Bandwidth = 0.35f, Frequency = 240, Gain = 0},    //4
                        new EqBand {Bandwidth = 0.35f, Frequency = 420, Gain = 0},    //5
                        new EqBand {Bandwidth = 0.75f, Frequency = 650, Gain = 0},    //6
                        new EqBand {Bandwidth = 0.75f, Frequency = 900, Gain = 0},    //7
                        new EqBand {Bandwidth = 0.75f, Frequency = 1200, Gain = 0},   //8
                        new EqBand {Bandwidth = 0.75f, Frequency = 1500, Gain = 0},   //9
                        new EqBand {Bandwidth = 0.75f, Frequency = 2200, Gain = 0},   //10
                        new EqBand {Bandwidth = 0.75f, Frequency = 3400, Gain = 0},   //11
                        new EqBand {Bandwidth = 0.75f, Frequency = 4600, Gain = 0},   //12
                        new EqBand {Bandwidth = 0.75f, Frequency = 6000, Gain = 0},   //13
                        new EqBand {Bandwidth = 0.75f, Frequency = 7800, Gain = 0},   //14
                        new EqBand {Bandwidth = 0.75f, Frequency = 9000, Gain = 0},   //15
                        new EqBand {Bandwidth = 0.75f, Frequency = 12000, Gain = 0},  //16
                        new EqBand {Bandwidth = 0.75f, Frequency = 16000, Gain = 0},  //17
                        new EqBand {Bandwidth = 0.75f, Frequency = 20000, Gain = 0},  //18
                    };
        ...
        public void ChangeEQ(EqBand[] bands)
        {
            this.bands = bands;
